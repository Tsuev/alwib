import {
  script
} from "./chunk-3NGUKXXM.js";
import "./chunk-B73TEBOQ.js";
import {
  BaseStyle
} from "./chunk-AO2R5CUR.js";
import {
  computed,
  createBlock,
  createElementBlock,
...
var useForm = function useForm2() {
  ...
  var valid = computed(function() {
    return Object.values(_states).every(function(field2) {
  ...
  var getInitialState = function getInitialState2(field2, initialValue) {
    return {
      value: initialValue !== null && initialValue !== void 0 ? initialValue : getValueByPath(options.initialValues, field2),
      touched: false,
      dirty: false,
      pristine: true,
      valid: true,
  ...
  var defineField = function defineField2(field2, fieldOptions) {
    ...
    (_fields$field2 = fields[field2]) === null || _fields$field2 === void 0 || _fields$field2._watcher.stop();
    _states[field2] || (_states[field2] = getInitialState(field2, fieldOptions === null || fieldOptions === void 0 ? void 0 : fieldOptions.initialValue));
    var props = mergeProps((_resolve = resolve(fieldOptions, _states[field2])) === null || _resolve === void 0 ? void 0 : _resolve.props, resolve(fieldOptions === null || fieldOptions === void 0 ? void 0 : fieldOptions.props, _states[field2]), {
      name: field2,
    ...
    var _watcher = watchPausable(function() {
      return _states[field2].value;
    }, function(newValue, oldValue) {
      if (_states[field2].pristine) {
        _states[field2].pristine = false;
      }
      if (newValue !== oldValue) {
        _states[field2].dirty = true;
      }
      validateFieldOn(field2, fieldOptions, "validateOnValueUpdate", true);
    });
    fields[field2] = {
      props,
      states: _states[field2],
      options: fieldOptions,
      _watcher
    };
    return [_states[field2], props];
  };
  ...
  var validate = function() {
    var _ref6 = _asyncToGenerator(_regeneratorRuntime().mark(function _callee4(field2) {
      ...
      return _regeneratorRuntime().wrap(function _callee4$(_context4) {
        while (1) switch (_context4.prev = _context4.next) {
          ...
          case 17:
            ...
            if (!(flattenFields.includes(fieldName) || !field2 || isEmpty(result.errors))) {
              _context4.next = 42;
              break;
            }
  ...
  var reset = function reset2() {
    Object.keys(_states).forEach(function() {
      var _ref10 = _asyncToGenerator(_regeneratorRuntime().mark(function _callee5(field2) {
        var _fields$field3;
        var watcher;
        return _regeneratorRuntime().wrap(function _callee5$(_context5) {
          while (1) switch (_context5.prev = _context5.next) {
            case 0:
              watcher = fields[field2]._watcher;
              watcher.pause();
              fields[field2].states = _states[field2] = getInitialState(field2, (_fields$field3 = fields[field2]) === null || _fields$field3 === void 0 || (_fields$field3 = _fields$field3.options) === null || _fields$field3 === void 0 ? void 0 : _fields$field3.initialValue);
              _context5.next = 5;
              return nextTick();
            case 5:
              watcher.resume();
  ...
  var setFieldValue = function setFieldValue2(field2, value) {
    _states[field2].value = value;
  };
  var getFieldState = function getFieldState2(field2) {
    var _fields$field4;
    return (_fields$field4 = fields[field2]) === null || _fields$field4 === void 0 ? void 0 : _fields$field4.states;
  };
  var setValues = function setValues2(values) {
    Object.keys(values).forEach(function(field2) {
      return setFieldValue(field2, values[field2]);
    });
  };
